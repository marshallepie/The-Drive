-- ============================================
-- Drive Platform - Supabase Database Setup
-- ============================================
...
CREATE INDEX IF NOT EXISTS idx_finance_applications_user ON finance_applications(user_id);
CREATE INDEX IF NOT EXISTS idx_finance_applications_vehicle ON finance_applications(vehicle_id);
...
-- Add triggers for updated_at (drop first if exists to avoid errors)
...
DROP TRIGGER IF EXISTS update_finance_applications_updated_at ON finance_applications;
